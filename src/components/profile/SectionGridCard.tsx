...
const SectionGridCard = ({ section, isOwner, isExpanded, onClick, onDeleted, onRenamed, index }: Props) => {
  ...
  if (editing) {
    return (
      <div className="w-full flex items-center gap-2 bg-card rounded-xl border border-primary/30 p-2.5">
        <Input
          value={editName}
  ...
  return (
    <>
      <div className="relative w-full">
        <button
          onClick={onClick}
          className={`group relative w-full aspect-[4/5] rounded-xl overflow-hidden border border-border text-left transition-all active:scale-[0.97] ${
