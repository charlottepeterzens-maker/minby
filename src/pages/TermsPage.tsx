    ...
    <div className="min-h-screen" style={{ backgroundColor: "hsl(var(--color-surface))" }}>
      <div className="max-w-[600px] mx-auto px-6 py-6 pt-safe">
        ...
        <div className="space-y-6 text-[13px] leading-[1.7]" style={{ color: "#5A4A65" }}>
          <section>
            <h2 className="font-medium text-[16px] mb-1.5" style={{ color: "hsl(var(--color-text-primary))" }}>Tjänsten</h2>
            <p>Minby är en social app i testfas driven av Charlotte Peterzéns.</p>
          </section>

          <section>
            <h2 className="font-medium text-[16px] mb-1.5" style={{ color: "hsl(var(--color-text-primary))" }}>Ålder</h2>
            <p>Du måste vara minst 18 år för att använda tjänsten.</p>
          </section>

          <section>
            <h2 className="font-medium text-[16px] mb-1.5" style={{ color: "hsl(var(--color-text-primary))" }}>Ditt innehåll</h2>
            <p>Du ansvarar själv för det innehåll du publicerar i appen.</p>
          </section>

          <section>
            <h2 className="font-medium text-[16px] mb-1.5" style={{ color: "hsl(var(--color-text-primary))" }}>Testfas</h2>
            <p>Tjänsten är under aktiv utveckling och kan ändras eller avslutas när som helst.</p>
          </section>

          <section>
            <h2 className="font-medium text-[16px] mb-1.5" style={{ color: "hsl(var(--color-text-primary))" }}>Uppförande</h2>
